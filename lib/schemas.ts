...
export const GeoResultSchema = z.object({
  ...
  measurement_methodology: z.object({ market: z.string().nullable(), languages_tested: z.array(z.string()), supplemental_languages_tested: z.array(z.string()).optional(), core_queries: z.number(), supplemental_queries: z.number(), providers: z.array(z.object({ engine: z.string(), model: z.string().nullable() })), samples_per_combination: z.number(), user_location: z.null(), location_behavior: z.string(), untested_languages_disclosure: z.string().optional(), search_mode_disclosure: z.string().optional() }).optional(),
})
